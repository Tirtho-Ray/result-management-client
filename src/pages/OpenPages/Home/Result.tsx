    ...
    return (
      <div>
        <div className="flex justify-center mt-4">
          <div className="h-40 w-[390px] md:h-32 md:w-[600px] lg:h-32 lg:w-[500px] bg-stone-500 rounded-md">
            ...
            <div className=" flex justify-center mt-3">
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4 place-items-center ">
                <div>
                  <input
                    className="rounded-sm px-4 py-2 w-40 h-8 md:w-44  md:h-10 lg:w-64 focus:outline-none"
                    type="text"
                    placeholder="Roll"
                  />
                </div>
                <div>
                  <select
                    className="rounded-sm px-4 w-40 h-8 md:w-44 md:h-10 lg:w-64 focus:outline-none"
                    name=""
                    id=""
                  >
